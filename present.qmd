...
* Inter-Mountain Basins Semi-Desert Shrub-Steppe is the most dominant EVT at ~22%.  
* Roughly 15% of the subregion is mapped in agricultural land use. 
...
From this information, we can see that the majority of this subregion is classified as “shrub,” comprising approximately 55% of the vegetation cover.
...
From these results, we can see the majority of vegetation on the landscape is .02 - .05 meters in height.
